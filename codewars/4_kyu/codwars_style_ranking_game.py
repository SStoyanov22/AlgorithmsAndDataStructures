...
class User:
    ...
    def inc_progress(self,activity_rank):
        ...
        d = activity_rank_index - current_rank_index
        if d>0:
            inc = 10*d*d
        elif d==0:
            inc = 3
            ...
            inc = 0
        rank_up = int((self.progress+inc)/100)

        self.rank = 8 if current_rank_index + rank_up>= len(RANKS) else RANKS[current_rank_index + rank_up]
        self.progress = 0 if self.rank ==8 else (self.progress + inc) %100
